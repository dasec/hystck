 ...
 * This Plugin provides an interface for the hystck agent application to remotely control libpurple based messengers.<br>
 ...
 * You can find the hystck project master page at: <a href="http://hystck.fbi.h-da.de">http://hystck.fbi.h-da.de</a>
 *
