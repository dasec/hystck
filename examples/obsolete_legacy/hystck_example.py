...
def gen_email_traffic(guest, logger):
    ...
    mailerobj.set_config("Windows guest", "hystck007@gmail.com", "f!8Uq6b7hKMJX9vz", "hystck007@gmail.com",
        "imap.googlemail.com", "smtp.googlemail.com")

    #logger.debug("hystckmanager: config is set up, next step: create")
    mailerobj.open()
    ...
    mailerobj.send_mail("hystck007@gmail.com", "Linux guest is alive", "Hello dude!")
