...
try:
    ...
    from hystck.core.reporter import Reporter
...
def test_firefox(guest, logger):
    ...
    while browser_obj.is_busy:
        time.sleep(5)
    browser_obj.facebook_login("tom-g1@gmx.de", "FBgoeshystck", "loginbutton")  # Credentials need to be changed, button id is correct.
    time.sleep(25)
    # download file
