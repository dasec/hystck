...
try:
    ...
    from hystck.botnet.core.botmonitorbase import BotMonitorBase
    from hystck.botnet.core.simulationmanager import SimulationManager
    from hystck.botnet.bots.zeus.zeus_generators import ZeusPacketGenerator
    from hystck.botnet.bots.zeus.zeus import ZeusCnC
