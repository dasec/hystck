...
echo "Only run this script when using the python 2 version of hystck. This will backup the sources.list and change it as well as install packages no longer available via packet managers."
