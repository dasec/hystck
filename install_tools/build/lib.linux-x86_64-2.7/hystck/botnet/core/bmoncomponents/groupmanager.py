...
class GroupManager(LoggerBase):
    ...
    def __init__(self, bot_registry, payload_registry):
        ...
        :type payload_registry: hystck.core.bmoncomponents.payloadregistry.PayloadRegistry
        :type bot_registry: hystck.core.bmoncomponents.botregistry.BotRegistry
        """
    ...
    def __add_bot_to_group_by_guest_object(self, group_name, guest_object):
        ...
        :type guest_object: hystck.core.guest.Guest
        :type group_name: str
        :param group_name: a symbolic group name
    ...
    def add_bot_to_group(self, group, guest_or_ip):
        ...
        :type guest_or_ip: hystck.core.guest.Guest | str
        :type group: str
