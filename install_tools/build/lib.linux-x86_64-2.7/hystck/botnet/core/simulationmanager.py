...
from hystck.botnet.core.agentconnectorbase import BotStates
...
class SimulationManager(LoggerBase):
    ...
    :type bot_monitor: hystck.core.botmonitorbase.BotMonitorBase
    ...
    def wait_for_bot(self, guest_or_ip):
        ...
        :type guest_or_ip: str | hystck.core.guest.Guest
        :param guest_or_ip:
        """
    ...
    def generate_multiple_guests(vmm, amount, start_range=0, template="windows"):
        ...
        :rtype : list[hystck.core.guest.Guest]
        :type start_range: int
        :type amount: int
        :type vmm: hystck.core.vmm.Vmm
