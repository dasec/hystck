...
from hystck.botnet.net.proto import botmastermessage_pb2, messagetypes_pb2

from hystck.botnet.core.agentconnectorbase import AgentConnectorBase, AgentConnectorBaseDelegate
...
class BotMasterBase(AgentConnectorBase):
    ...
    def place_order(self, msg):
        ...
        if msg.HasExtension(botmastermessage_pb2.bm_order):
            ...
            unpacked_data = cPickle.loads(msg.Extensions[botmastermessage_pb2.bm_order].serialized_dict)
...
class BotMasterBaseDelegate(AgentConnectorBaseDelegate):
    ...
    def get_results(self, receiving_host, receiving_port):
        ...
        :type receiving_host: str or hystck.core.guest.Guest
        :param receiving_host: the server hosting the results
        :param receiving_port: the server port
        """
        if isinstance(receiving_port, Guest):
