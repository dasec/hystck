...
from hystck.botnet.core.agentconnectorbase import AgentConnectorBaseDelegate
from hystck.botnet.core.botbase import BotBaseDelegate
from hystck.botnet.core.botmasterbase import BotMasterBaseDelegate
from hystck.botnet.core.cncserverbase import CnCServerBaseDelegate

from hystck.botnet.core.bmoncomponents.botfactory import BotFactory
from hystck.botnet.common.loggerbase import LoggerBase
from hystck.utility import ip_range
...
class DelegateContainer(object):
    ...
    def __init__(self, delegate=None, gid=0):
        ...
        :type gid: int
        :type delegate: hystck.core.agentconnectorbase.AgentConnectorBaseDelegate or None
        """
...
class BotRegistry(LoggerBase):
    ...
    def get_bot(self, ip_address):
        ...
        :rtype : hystck.core.agentconnectorbase.AgentConnectorBaseDelegate
        :type ip_address: str
    ...
    def get_bot_list(self, gid=0):
        ...
        l = list()
        if gid == 0:
            for b in self.items.itervalues():
                l.append(b.delegate)
        else:
            for b in self.items.itervalues():
                if b.gid == gid:
