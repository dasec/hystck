...
from hystck.botnet.core import agentconnectorbase
from hystck.botnet.net import messagegenerator
from hystck.botnet.net.netutility import NetUtility
from hystck.botnet.net.proto import announcemessage_pb2
from hystck.botnet.net.proto import answermessage_pb2
from hystck.botnet.net.proto import genericmessage_pb2
from hystck.botnet.net.proto import messagetypes_pb2
from hystck.botnet.net.proto import payloadmessage_pb2

from hystck.botnet.core.bmoncomponents.botregistry import BotRegistry
from hystck.botnet.core.bmoncomponents.groupmanager import GroupManager
from hystck.botnet.core.bmoncomponents.payloadregistry import Payload, PayloadRegistry
...
class BotMonitorBase(TcpServerBase, LoggerBase, RuntimeQuery, ThreadManager):
    ...
    def server_stop_listener(self):
        ...
        for i in self.bot_registry.items.iteritems():
            try:
