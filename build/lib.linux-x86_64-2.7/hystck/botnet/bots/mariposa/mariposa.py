...
from hystck.botnet.bots.mariposa.mariposaprotocol import MariposaProtocol, MariposaMessageType
from hystck.botnet.common.loggerbase import LoggerBase, LoggerStatic
...
class ThreadedUDPRequestHandlerBotMaster(SocketServer.BaseRequestHandler):
...
class ThreadedUDPRequestHandlerCnC(SocketServer.BaseRequestHandler):
...
class ThreadedUDPRequestHandlerBot(SocketServer.BaseRequestHandler):
