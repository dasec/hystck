...
# browser to reduce the traffic dump created by hystck to contain as much packets related to the actual application
# (e.g. a video stream from youtube.com).
# Our motivation is to use hystck to create datasets as close as possible to the VPN-nonVPN dataset (ISCXVPN2016)
