...
from hystck.botnet.net import netutility
...
from hystck.botnet.net.proto import genericdatamessage_pb2
...
class AgentConnectorBase(TcpClientBase, LoggerBase, RuntimeQuery):
    ...
    def _set_globals(self, msg):
        ...
        if msg.HasExtension(genericdatamessage_pb2.data):
            new_globals = cPickle.loads(msg.Extensions[genericdatamessage_pb2.data].content)
    ...
    #
    #     :type func: func of f(hystck.net.proto.genericmessage_pb2.GenericMessage)
    #     :type message_type: hystck.net.proto.messagetypes_pb2.MessageType
    #     :param message_type: Corresponds to a type specified in hystck.net.proto.messagetypes.proto
...
class AgentConnectorBaseDelegate(LoggerBase):
    ...
    def load_payload(self, payload):
        ...
        :type payload: hystck.core.bmoncomponents.payloadregistry.Payload
        """
