...
import SocketServer  # if you want to create a udp or tcp server
import socket  # socket operations and exceptions
import threading  # for running stuff on other threads

from hystck.botnet.core.botmasterbase import BotMasterBase  # the template component for the botmaster
from hystck.botnet.core.cncserverbase import CnCServerBase  # the template component for the cnc-server
from hystck.botnet.core.botbase import BotBase  # the template component for the bot

from hystck.botnet.common.loggerbase import LoggerStatic  # if you need the static logger (ex. sockserver-handlers)
from hystck.botnet.net.netutility import NetUtility  # for fast creation of sockets
