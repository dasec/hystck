...
FILEPATH_TEMPLATE_IMAGES = "/data/hystck-pool/"       # where are the template images stored
#FILEPATH_LOCAL_IMAGES = "/var/lib/libvirt/images/backing/"          # where will the differential images be placed
FILEPATH_LOCAL_IMAGES = "/data/hystck-pool/backing/"          # where will the differential images be placed
