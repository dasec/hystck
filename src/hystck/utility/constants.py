...
FILEPATH_TEMPLATE_IMAGES = "/data/images/"       # where are the template images stored
...
NETWORK_INTERNET_BRIDGE_INTERFACE = 'virbr0'                  # hypervisor bridge interface for internet traffic
