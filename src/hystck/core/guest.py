...
class Guest(object):
    ...
    def extractInternetNetworkInterface(self, remote=False):
        ...
        guestInterfacesInfo = subprocess.check_output(cmd)
    ...
    def startSniffer(self):
        ...
        try:
            ...
            self.logger.error(" guest::startSniffer ->" + self.guestname + " failed:" + str(e))
    ...
    def send(self, msg):
        ...
        try:
            ...
            if self.state == "connected":
                ...
                sent = self.socket.sendall(buffer)
    ...
    def shellExec(self, cmd, path_prefix="#unset", std_in=None):
        ...
        msg += " " + base64.b64encode(cmd)  # use base64 encoding to prevent fragmentation
        msg += " " + base64.b64encode(path_prefix)
    ...
    def CopyDirectoryToGuest(self, directory, target_dir):
        ...
        z.close()
        msg = "file dircopy " + base64.b64encode(target_dir) + " " + base64.b64encode(zbuf.getvalue())
        self.send(msg)
        zbuf.close()
    ...
    def guestTouchFile(self, target_file):
        ...
        """
        msg = "file touch "
        msg += base64.b64encode(target_file)
        self.send(msg)
    ...
    def guestDelete(self, guest_target_path):
        ...
        msg += base64.b64encode(guest_target_path)
        self.send(msg)
    ...
    def setOSTime(self, ptime, local_time=True):
        ...
        """
        msg = "setOSTime " + base64.b64encode(ptime) + " "
        if local_time:
            msg += "True"
        else:
            msg += "False"
